...
class WebAuthnRegister extends Component
{
    ...
    public function mount(): void
    {
        ...
        $user = [
            'id' => $this->base64url_encode((string) auth()->user()->id),
        ...
        $pubKeyCredParams = [
            ...
            ['type' => 'public-key', 'alg' => -257],  // RS256 (recommended)
        ];
    ...
    public function registerKey($credential): void
    {
        ...
        if (WebAuthnKey::where('credentialId', base64_encode($credentialId))->exists()) {
            return;
        }
        ...
        WebAuthnKey::create([
            ...
            'attestationType' => base64_encode($data['response']['attestationObject'] ?? ''),
